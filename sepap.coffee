...
i=0
makeRequest({'channel':'1/1','time':8,'id':i,'ext':'c','return_type':1,'command': "gcc -x c -o %s %s.c",'source':"\"#include<stdio.h>\\n\\nint main()\\n{\\n char string [256];\\n gets (string);\\n while (1) {\\n printf(\\\"\\\");}\\n  printf(\\\"adios\\\");\\n return 0;\\n}\\n\"", 'cases': {'0':{ 'input':"0", 'output' : "0\n"} ,'1':{ 'input':"1\n", 'output' : "1\n"},'2':{ 'input':"1\n", 'output' : "1\n"},'3':{ 'input':"1\n", 'output' : "1\n"}}},"/",6666)


i=1
makeRequest({'channel':'1/1','time':1,'id':i,'ext':'c','return_type':1,'command': "gcc -x c -o %s %s.c",'source':"\"#include<stdio.h>\\n\\nint main()\\n{\\n char string [256];\\n gets (string);\\n printf(\\\"%s\\\\n\\\",string);\\n return 0;\\n}\\n\"", 'cases': {'0':{ 'input':"0", 'output' : "0\n"} ,'1':{ 'input':"1\n", 'output' : "1\n"}}},"/",6666)
...
#i=4
#makeRequest({'channel':'1/1','time':1,'id':i,'ext':'c','return_type':0,'command': "gcc -x c -o %s %s.c",'source':"\"#include<stdio.h>\\n\\nint main()\\n{\\n char string [256];\\n gets (string);\\n printf(\\\"%s\\\\n\\\",string);\\n return 0;\\n}\\n\"", 'cases': {'0':{ 'input':"0", 'output' : "0\n"} ,'1':{ 'input':"1\n", 'output' : "1\n"}}},"/",6666)
#i=2
#makeRequest({'channel':'1/1','time':1,'id':i,'ext':'c','return_type':1,'command': "gcc -x c -o %s %s.c",'source':"\"#include<stdio.h>\\n\\nint main()\\n{\\n char string [256];\\n gets (string);\\n printf(\\\"adios\\\"\\n return 0;\\n}\\n\"", 'cases': {'0':{ 'input':"0", 'output' : "0\n"} ,'1':{ 'input':"1\n", 'output' : "1\n"}}},"/",6666)
#i=3
#makeRequest({'channel':'1/1','time':1,'id':i,'ext':'c','return_type':1,'command': "gcc -x c -o %s %s.c",'source':"\"#include<stdio.h>\\n\\nint main()\\n{\\n char string [256];\\n gets (string);\\n return 0;\\n}\\n\"", 'cases': {'0':{ 'input':"0", 'output' : "0\n"} ,'1':{ 'input':"1\n", 'output' : "1\n"}}},"/",6666)
